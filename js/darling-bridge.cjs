...
try {
    ...
    try {
        ...
        native = {
            ...
            showDarlingWindow: () => { throw new Error('Darling native addon not loaded') },
            hideDarlingWindow: () => { throw new Error('Darling native addon not loaded') },
            focusDarlingWindow: () => { throw new Error('Darling native addon not loaded') },
            isVisible: () => { throw new Error('Darling native addon not loaded') },
            isFocused: () => { throw new Error('Darling native addon not loaded') },
            setWindowOpacity: () => { throw new Error('Darling native addon not loaded') },
            setAlwaysOnTop: () => { throw new Error('Darling native addon not loaded') },
            setTitlebarColor: () => { throw new Error('Darling native addon not loaded') },
            setCornerPreference: () => { throw new Error('Darling native addon not loaded') },
            flashWindow: () => { throw new Error('Darling native addon not loaded') },
            getDpi: () => { throw new Error('Darling native addon not loaded') },
            getScaleFactor: () => { throw new Error('Darling native addon not loaded') },
        }
    }
};
...
module.exports = {
    ...
    setWindowOpacity: (win, opacity) => native.setWindowOpacity(win, opacity),
    ...
    isVisible: (win) => native.isVisible(win),
    isFocused: (win) => native.isFocused(win),
    ...
    setTitlebarColor: (win, color) => native.setTitlebarColor(win, color),
    setCornerPreference: (win, pref) => native.setCornerPreference(win, pref),
    flashWindow: (win, continuous) => native.flashWindow(win, continuous),
    getDpi: (win) => native.getDpi(win),
    getScaleFactor: (win) => native.getScaleFactor(win),
};
